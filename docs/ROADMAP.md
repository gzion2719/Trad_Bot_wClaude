...
**Remaining:**
- 5.7 [~] Monitoring dashboard — Phase 1 (read-only) ✅ + Phase 2 (System card: gateway/PID/uptime/port) ✅ + weekend-aware stale threshold ✅; Phase 3 control plane (kill/restart with token auth) pending
