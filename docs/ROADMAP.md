...
**Remaining:**
- 5.7 [x] Monitoring dashboard — Phase 1 (read-only) ✅ + Phase 2 (System card: gateway/PID/uptime/port) ✅ + weekend-aware stale threshold ✅ + Phase 3 control plane ✅ + Phase 4 (IBKR Account tab: KPI strip, equity chart, positions table, balances; file-IPC via account_snapshot.json; 47 new tests) ✅ 2026-05-04. Phase 5+ (per-strategy analytics, UI redesign) tracked in BACKLOG.
